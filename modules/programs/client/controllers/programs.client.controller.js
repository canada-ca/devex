(function () {
	...
	//
	// =========================================================================
	.controller('ProgramViewController', ['$window', '$sce', 'program', 'AuthenticationService', 'ProgramsService', 'Notification', 'dataService', '$filter', '$translate', function ($window, $sce, program, authenticationService, ProgramsService, Notification, dataService, $filter, $translate) {
		var vm                 = this;
		vm.program             = program;
		vm.display             = {};
